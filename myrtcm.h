...
public:
    ...
    const rtcm1004& getMsg1004() const;
    void printMsg1004() const;
...
private:
    ...
    int byteVector2int(vector<unsigned char>& byteVector, int numBits) const;

    void formatOutMsg1004(const rtcm1004& msg1004) const;
};
